...
public class ActiveUserAccountController {
    ...
    @PostMapping("")
    public Mono<Boolean> registerUser(@RequestBody Mono<CodeVerification> codeVerificationMono) {
        return activateUserAccountUseCase.activateUserAccount(codeVerificationMono);
    }
}
